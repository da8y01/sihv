...
class DatospersonalesController extends Controller
{
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='datospersonales-form')
		{
	...
	public function actionPdf() {
		...
		if(isset($_GET['pdf']))
		{
			...
			# Outputs ready PDF
			$mPDF1->Output('Datospersonales_'.date("Y-m-d"),EYiiPdf::OUTPUT_TO_DOWNLOAD);
		}
    }
	...
	public function actionExcel() {
		...
		Yii::app()->request->sendFile("Datospersonales_".date("Y-m-d").".xls",$content);
    }
}
