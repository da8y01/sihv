...
class EducacionsuperiorController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Educacionsuperior'];
			if($model->save()){
				if(Yii::app()->request->isAjaxRequest){
					echo (1)."---".$model->id;
					Yii::app()->end();
	...
	{
		$dataProvider=new CActiveDataProvider('Educacionsuperior');
	...
	{
		$model=new Educacionsuperior('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Educacionsuperior']))
			$model->attributes=$_GET['Educacionsuperior'];
	...
	{
		$model=Educacionsuperior::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='educacionsuperior-form')
		{
	...
	public function actionPdf() {
		...
		//$model->unsetAttributes();  // clear any default values
		//$dataProvider=new CActiveDataProvider('Educacionsuperior');
		$model=Educacionsuperior::model()->findAll();
		if(isset($_GET['pdf']))
		{
			...
			# Outputs ready PDF
			$mPDF1->Output('Educacionsuperior_'.date("Y-m-d"),EYiiPdf::OUTPUT_TO_DOWNLOAD);
		}
    }
	...
	public function actionExcel() {
		...
		Yii::app()->request->sendFile("Educacionsuperior_".date("Y-m-d").".xls",$content);
    }
}
