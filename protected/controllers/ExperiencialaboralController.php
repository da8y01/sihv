...
class ExperiencialaboralController extends Controller
{
	...
	public function actionPdf() {
		...
		//$model->unsetAttributes();  // clear any default values
		//$dataProvider=new CActiveDataProvider('Experiencialaboral');
		$model=Experiencialaboral::model()->findAll();
		if(isset($_GET['pdf']))
		{
			...
			# Outputs ready PDF
			$mPDF1->Output('Experiencialaboral_'.date("Y-m-d"),EYiiPdf::OUTPUT_TO_DOWNLOAD);
		}
    }
	...
	public function actionExcel() {
		...
		Yii::app()->request->sendFile("Experiencialaboral_".date("Y-m-d").".xls",$content);
    }
}
