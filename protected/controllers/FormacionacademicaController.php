...
class FormacionacademicaController extends Controller
{
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='formacionacademica-form')
		{
	...
	public function actionPdf() {
		...
		//$model->unsetAttributes();  // clear any default values
		//$dataProvider=new CActiveDataProvider('Formacionacademica');
		$model=Formacionacademica::model()->findAll();
		if(isset($_GET['pdf']))
		{
			...
			# Outputs ready PDF
			$mPDF1->Output('Formacionacademica_'.date("Y-m-d"),EYiiPdf::OUTPUT_TO_DOWNLOAD);
		}
    }
	...
	public function actionExcel() {
		...
		Yii::app()->request->sendFile("Formacionacademica_".date("Y-m-d").".xls",$content);
    }
}
