...
class TiempoexperienciaController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Tiempoexperiencia'];
			if($model->save()){
				if(Yii::app()->request->isAjaxRequest){
					echo (1)."---".$model->id;
					Yii::app()->end();
	...
	{
		$dataProvider=new CActiveDataProvider('Tiempoexperiencia');
	...
	{
		$model=new Tiempoexperiencia('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tiempoexperiencia']))
			$model->attributes=$_GET['Tiempoexperiencia'];
	...
	{
		$model=Tiempoexperiencia::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tiempoexperiencia-form')
		{
	...
	public function actionPdf() {
		...
		//$model->unsetAttributes();  // clear any default values
		//$dataProvider=new CActiveDataProvider('Tiempoexperiencia');
		$model=Tiempoexperiencia::model()->findAll();
		if(isset($_GET['pdf']))
		{
			...
			# Outputs ready PDF
			$mPDF1->Output('Tiempoexperiencia_'.date("Y-m-d"),EYiiPdf::OUTPUT_TO_DOWNLOAD);
		}
    }
	...
	public function actionExcel() {
		...
		Yii::app()->request->sendFile("Tiempoexperiencia_".date("Y-m-d").".xls",$content);
    }
}
