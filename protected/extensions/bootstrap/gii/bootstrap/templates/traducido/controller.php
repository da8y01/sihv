...
class <?php echo $this->controllerClass; ?> extends <?php echo $this->baseControllerClass."\n"; ?>
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['<?php echo $this->modelClass; ?>']))
		{
			...
			if($model->save()){
				if(Yii::app()->request->isAjaxRequest){
					echo (1)."---".$model-><?php echo $this->tableSchema->primaryKey; ?>;
					Yii::app()->end();
				}
				else{
	...
	public function actionPdf() {
		...
		if(isset($_GET['pdf']))
		{
			...
			# Outputs ready PDF
			$mPDF1->Output('<?php echo $this->modelClass; ?>_'.date("Y-m-d"),EYiiPdf::OUTPUT_TO_DOWNLOAD);
		}
    }
	...
	public function actionExcel() {
		...
		Yii::app()->request->sendFile("<?php echo $this->modelClass; ?>_".date("Y-m-d").".xls",$content);
    }
}
