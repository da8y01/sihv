...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/sihv.css" />
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/iCheck-master/skins/all.css" />
	...
	<?php 
		...
		$importador->registerScriptFile(Yii::app()->request->baseUrl.'/iCheck-master/jquery.icheck.min.js');
	?>
